...
class EmailResource(object):
    ...
    def on_post(self, req, resp):
        ...
        server.starttls()
        server.login(os.getenv('GMAIL_USERNAME', 'ocp3.test@gmail.com'), os.getenv('GMAIL_PASSWORD', '0cp3te5T'))
        msg = email_req['msg']
        server.sendmail(os.getenv('GMAIL_USERNAME', 'ocp3.test@gmail.com'), email_req['to'], msg)
        server.quit()
        config = {
        ...
        try:
            with connection.cursor() as cursor:
                ...
                data_email = (os.getenv('GMAIL_USERNAME', 'ocp3.test@gmail.com'), email_req['to'], 'New registration',msg, datetime.now())
